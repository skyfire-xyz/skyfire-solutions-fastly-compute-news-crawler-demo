        ...
        <div className="max-w-4xl">
          ...
          <div className="mb-6 flex gap-6">
            <div className="flex items-start gap-3">
              <svg className="mt-0.5 size-5 flex-shrink-0 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-start gap-3">
              <svg className="mt-0.5 size-5 flex-shrink-0 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
